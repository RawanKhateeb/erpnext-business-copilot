            ...
            if self.use_modern_api:
                response = self.client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": "You are a procurement analyst. Generate clear, professional procurement reports with structured sections and headings. Use short paragraphs and bullet-point metrics. Use plain text (no markdown). Use line breaks between sections. Focus on business insights and actionable recommendations."
...
FORMAT REQUIREMENTS:
1. Start with "EXECUTIVE SUMMARY" - 2-3 sentences overview
2. Add "KEY METRICS" - bullet-point list of key figures
3. Follow with "SPENDING ANALYSIS" - paragraph analyzing spending patterns
4. Add "SUPPLIER PERFORMANCE" - paragraph about top suppliers
5. Add "ORDER STATUS REVIEW" - paragraph about order statuses
6. End with "RECOMMENDATIONS" - bullet-point list of 3 actionable items
7. Add closing paragraph summarizing the report
